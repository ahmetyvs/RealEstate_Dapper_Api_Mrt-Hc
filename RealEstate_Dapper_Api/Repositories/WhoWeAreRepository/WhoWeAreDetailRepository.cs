...
namespace RealEstate_Dapper_Api.Repositories.WhoWeAreRepository
{
    public class WhoWeAreDetailRepository : IWhoWeAreDetailRepository
    {
        ...
        {
            string query = "insert into WhoWeAreDetail (Title,SubTitle,Description1,Description2,Status) values (@title,@subTitle,@description1,@description2,@status)";
            var parameters = new DynamicParameters();
            parameters.Add("@title", createWhoWeAreDetailDto.Title);
            parameters.Add("@subTitle", createWhoWeAreDetailDto.SubTitle);
            parameters.Add("@description1", createWhoWeAreDetailDto.Description1);
            parameters.Add("@description2", createWhoWeAreDetailDto.Description2);
            parameters.Add("@status", createWhoWeAreDetailDto.Status);
        ...
        {
            string query = "Update WhoWeAreDetail Set Title=@title,SubTitle=@subTitle,Description1=@description1,Description2=@Description2,Status=@status where WhoWeAreDetailID=@whoWeAreDetailID";
            var parameters = new DynamicParameters();
            ...
            parameters.Add("@status", updateWhoWeAreDetailDto.Status);
            //parameters.Add("@status", true);
