...
namespace RealEstate_Dapper_Api.Repositories.ServiceRepository
{
    public class ServiceRepository : IServiceRepository
    {
        ...
        {
            string query = "Select * From Service"; // Tamamını getiriyor
            //string query = "SELECT TOP 3 * FROM Service"; // İlk üçünü getiriyor.
            //string query = "SELECT TOP 3 * FROM dbo.Service ORDER BY ServiceID DESC"; // Son üçünü getiriyor
            using (var connection = _context.CreateConnection())
            {
